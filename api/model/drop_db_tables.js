...
const queryStrArray = [queryStr.dropDirectorsTable, queryStr.dropActorsTable, queryStr.dropWatchlistsTable, queryStr.dropAuditionsTable, queryStr.dropNotesTable, queryStr.dropDirectorWatchlistsTable, queryStr.dropWatchlistActorsTable];

// DROP tables
async function dropTables () {
  console.log('DROPPING psql database TABLES...');
  // connect to pool
  await pool.connect()
    .then(async (client) => {
