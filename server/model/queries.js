module.exports = {
  ...
  createWatchlistsTable: 'CREATE TABLE IF NOT EXISTS watchlists (id SERIAL PRIMARY KEY, list_name VARCHAR(50) NOT NULL, list_description VARCHAR)',
  ...
  seedWatchlistsTable: 'INSERT INTO watchlists("list_name", "list_description") VALUES ($1, $2) RETURNING *',
